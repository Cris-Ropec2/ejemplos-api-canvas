...
function draw() {
  ...
  ctx.moveTo(435, 100);
  ctx.arc(400, 100, 35, 0, Math.PI);

  ctx.moveTo(390, 90);
  ctx.arc(385, 90, 5, 0, Math.PI * 2);

  ctx.moveTo(420, 90);
  ctx.arc(415, 90, 5, 0, Math.PI * 2);
  ...
  // ===================================================
  // 5️⃣ Curvas cuadráticas de Bézier
  // ===================================================
...
// Esquina curva superior izquierda
ctx.beginPath();
